...
my_distance = convert_distance(5)
print(my_distance)
...
# accepts three parameters: hours, minutes, and seconds. Remember, 
# to define a function, you use the def keyword followed by the function 
# name and parentheses. The function parameters go inside the parentheses 
# in the function definition, and they represent the values that will be 
# given to the function when it is called. Also remember that the print 
# function is a built-in Python function that outputs its arguments to the
#  console. You call a function by using its name followed by parentheses,
